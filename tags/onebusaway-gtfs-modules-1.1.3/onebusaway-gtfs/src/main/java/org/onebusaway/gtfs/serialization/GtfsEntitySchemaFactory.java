...
public class GtfsEntitySchemaFactory {
  ...
  public static DefaultEntitySchemaFactory createEntitySchemaFactory() {
    ...
    helper.addField(pathways, "id", "pathway_id", new DefaultAgencyIdFieldMappingFactory());
    helper.addField(pathways, "fromStop", "from_stop_id", new EntityFieldMappingFactory());
    helper.addField(pathways, "toStop", "to_stop_id", new EntityFieldMappingFactory());
